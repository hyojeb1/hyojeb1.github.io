...
영감을 준 것은 바로 Dua Lipa의 *Levitating* 공식 애니메이션 뮤직비디오였습니다.
...
![Aseprite에서 1000%로 크기를 키워 내보내는 과정](./스크린샷 2026-03-11 120537.png '비율을 1000%로 키워 깍두기 형태를 거대하게 만듭니다.')
...
![비트맵 추적 세팅 화면](./스크린샷 2026-03-11 113727.png '모든 스무딩 옵션을 꺼야 완벽한 직각 벡터가 생성됩니다.')
...
![Optimized SVG 저장 옵션](./스크린샷 2026-03-11 123108.png '웹 로딩 속도를 위해 코드를 다이어트 시키는 과정입니다.')
