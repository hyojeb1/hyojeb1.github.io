...
const config: SiteConfig = {
  ...
  site: 'https://hyojeb1.github.io',
  // The name of your site, used in the title and for SEO.
  title: 'hyojeb1',
  // The description of your site, used for SEO and RSS feed.
  description:
    'Welcome to Hyoje’s blog — a 3D graphics and engine programmer pursuing beauty.',
  ...
  socialCardAvatarImage: './src/content/jebi_avatar.png',
  ...
  //       'monokai', 'night-owl', 'nord', 'one-dark-pro', 'one-light', 'plastic', 'poimandres',
  //       'red', 'rose-pine', 'rose-pine-dawn', 'rose-pine-moon', 'slack-dark', 'slack-ochin',
  ...
  socialLinks: {
    github: 'https://github.com/hyojeb1',
    //mastodon: 'https://github.com/stelcodes/multiterm-astro',
    email: 'wkdgywp@gmail.com',
    linkedin: 'https://www.linkedin.com/in/hyoje-jang-645853227/',
  ...
  giscus: {
    repo: 'hyojeb1/hyojeb1.github.io', 
    repoId: 'R_kgDORjF_WQ',
    category: 'General',
    categoryId: 'DIC_kwDORjF_Wc4C4JPx',
